...
In both cases Black Cat will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Black Cat will wait file message from you. Type /cancel to leave from it.
