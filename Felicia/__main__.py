...
from Felicia import TOKEN, bot, dp
from Felicia.config import get_bool_key, get_list_key
from Felicia.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("Felicia.modules." + module_name)
...
import_module("Felicia.modules.pm_menu")
# Import misc stuff
import_module("Felicia.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("Felicia.utils.sentry")
