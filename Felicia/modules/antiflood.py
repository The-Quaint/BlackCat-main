...
from Felicia.modules.utils.connections import chat_connection
from Felicia.modules.utils.language import get_strings, get_strings_dec
from Felicia.modules.utils.message import (
    InvalidTimeUnit,
    convert_time,
    get_args,
    need_args_dec,
)
from Felicia.modules.utils.restrictions import ban_user, kick_user, mute_user
from Felicia.modules.utils.user_details import get_user_link, is_user_admin
from Felicia.services.mongo import db
from Felicia.services.redis import bredis, redis
from Felicia.utils.cached import cached
...
Black Cat: <code>Please send expiration time [...]</code>
