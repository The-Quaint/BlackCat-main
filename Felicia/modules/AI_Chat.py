...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Felicia AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Felicia AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Felicia AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Felicia AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
__help__ = """
<b> Chatbot </b>
Felicia AI 1.4 IS THE ONLY AI SYSTEM WHICH CAN DETECT & REPLY UPTO 200 LANGUAGES
...
<b> Assistant </b>
 - /ask <i>question</i>: Ask question from Felicia
