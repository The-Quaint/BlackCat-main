...
from Felicia.modules.utils.disable import disableable_dec
...
STICKERS = (
    "CAACAgUAAxkBAAEC7cRhRuW7bWHO7kvu64maWG00DWBavQAC7AIAAnDkOFavHDvYQjM6FyAE",
    "CAACAgUAAxkBAAEC7cZhRuYSfgrWjZXI4RfCj4yHNGqclgACtAMAAifjOFYX669LFTrVaiAE",
    "CAACAgUAAxkBAAEC7chhRuYszC2foMe1kOd7ShsLpVIaggACVgQAAqZAOFZDf5pI74vnfCAE",
)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        InlineKeyboardButton(
            strings["btn_channel"], url="https://t.me/joinchat/JwlbATBEcT9kNjE9"
        ),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/joinchat/KvO34EwU6UNkNmRl"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "➕ Add Black Cat to your group ➕",
            url=f"http://t.me/feliciahardy_bot?startgroup=start",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/feliciahardy_bot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
